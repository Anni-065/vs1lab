...
var gtaLocator = (function GtaLocator(geoLocationApi) {
    ...
    return { // Start öffentlicher Teil des Moduls ...
        ...
        updateLocation: function() {
            // fetch location and set fields
            
            if(document.getElementById("tLatitude").getAttribute('value') == null || 
                    document.getElementById("tLongitude").getAttribute('value') == null || true) {
                console.log("lat/long not null");
                tryLocate(function(position) {
                    ...
                    var img_src = getLocationMapSrc(latitude, longitude, JSON.parse(taglist_json));
                    document.getElementById("result-img").setAttribute('src', img_src);
                }, function(msg) {
                    alert(msg);
                })
            }
