...
var gtaLocator = (function GtaLocator(geoLocationApi) {
    ...
    var apiKey = "nSyCCPp70XPoJX2SusmDp5oQHGXcnkh9";
        ...
        updateLocation: function() {
            tryLocate(
                function (position) {
                    ...
                    document.getElementById("tHashtag").value
                        = "#urass";

                    document.getElementById("result-img").src = getLocationMapSrc(lat, lon, [], 16);
